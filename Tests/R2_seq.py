...
# check whether refillItem endpoint of 
# restaurant microservice works correctly
...
def test():
    ...
    # add restId 102 with itemId 1 of qty 10
    ...
    # request restId 102 with itemId 1 and qty 21
    http_response =requests.post(
        "http://localhost:8080/acceptOrder", json = {"restId": 102, "itemId": 1, "qty":  21})
