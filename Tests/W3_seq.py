...
# check whether balance endpoint of 
...
def test():
    ...
    # check whether the balance of custId 302 is correct or not
    http_response =requests.get("http://localhost:8082/balance/302")

    if(http_response.status_code != 200):
        test_result = 'Fail'

    res_body = http_response.json();
    if res_body.get("custId") != 302 or res_body.get("balance") != 2000:
        test_result = "Fail"
